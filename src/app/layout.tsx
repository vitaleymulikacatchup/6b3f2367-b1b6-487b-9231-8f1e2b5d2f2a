...
export const metadata: Metadata = {
  title: "DomFoot - Find Football Matches & Connect Players",
  description: "DomFoot is the ultimate platform for football players aged 20-30. Find matches, build teams, connect with players, and compete in leagues.",
  keywords: "football, soccer, players, matches, teams, leagues, sports community",
  metadataBase: new URL("https://domfoot.com"),
  alternates: {
    canonical: "https://domfoot.com"
  },
  openGraph: {
    title: "DomFoot - Play Football Your Way",
    description: "Connect with football players, find matches, and grow your game on DomFoot.",
    siteName: "DomFoot",
    type: "website"
  },
  robots: {
